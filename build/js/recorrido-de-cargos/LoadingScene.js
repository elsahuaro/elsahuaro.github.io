class LoadingScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("recorrerBtn", "/img/recorrido-de-cargos/recorrer.png");
    this.load.image("reiniciarBtn", "/img/recorrido-de-cargos/reiniciar.png");
    for (var m of miembros) {
      this.load.image(m, "/img/recorrido-de-cargos/" + m + ".png");
    }
  }
